...
description: Make Starlight sidebar groups clickable by linking them to their index page.
head:
  - tag: title
    content: starlight-sidebar-clickable-groups
  - tag: style
    content: |
      .hero-html {
        --size: 12rem;
...
editUrl: false
hero:
  tagline: Make Starlight sidebar groups clickable by linking them to their index page.
  image:
    html: '🥕'
  actions:
    - text: Get Started
